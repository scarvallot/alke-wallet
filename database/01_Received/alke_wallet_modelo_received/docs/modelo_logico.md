# Modelo Lógico — AlkeWallet Received

Implementación lógica del modelo conceptual inicial para el sistema **AlkeWallet**. Se presentan las tablas, sus atributos, restricciones, claves foráneas y las cardinalidades resultantes. También se incluyen observaciones sobre las decisiones de diseño y sus implicaciones prácticas.
