# Decisiones de Diseño — AlkaWallet (Modelo Inicial)

Este documento describe el modelo de datos **recibido inicialmente** para el sistema AlkaWallet, identificando sus características, limitaciones y las mejoras propuestas para su evolución.
...
## Modelo Entidad-Relación — AlkaWallet (Versión Recibida)
